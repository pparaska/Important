...
public class AccountCUI {
	...
	/*
	 * private void updateBalance() { System.out.println("Enter Account Number");
	...
	/*
	 * private void updateAccount() { System.out.println("Enter Account Number ");
	 * int accountNumber = scanner.nextInt();
	 * 
	 * System.out.println("Enter  choice 1)Name" + " " + "2)salaried"); int
	 * userChoice = scanner.nextInt();
	 * 
	 * if (userChoice == 1) { System.out.println("Enter new Name"); String
	 * nameORSalary = scanner.nextLine(); nameORSalary = scanner.nextLine(); try {
	 * SavingsAccount updateAccount = savingsAccountService
	 * .updateAccount(accountNumber, userChoice, nameORSalary);
	 * System.out.println("Account Holder Name For Account Number " + accountNumber
	 * + " is Changed to " + nameORSalary); } catch (ClassNotFoundException |
	 * SQLException e) { e.printStackTrace(); }
	 * 
	 * } else if (userChoice == 2) {
	 * System.out.println(" Enter new salary type : true or false "); String
	 * nameORSalary = scanner.next(); try { SavingsAccount updateAccount =
	 * savingsAccountService .updateAccount(accountNumber, userChoice,
	 * nameORSalary); System.out.println("Salaried Type For Account Number " +
	 * accountNumber + " is Changed to " + nameORSalary); } catch
	...
	private void withdraw() {
		 ...
		 * } e.printStackTrace(); } catch (Exception e) { try { //DBUtil.rollback(); }
