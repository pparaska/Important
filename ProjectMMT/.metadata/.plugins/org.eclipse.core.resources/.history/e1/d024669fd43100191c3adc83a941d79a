...
public class BookingServiceResource {
	...
	/*
	 * @GetMapping("/") public ResponseEntity<List<Booking>>
	 * getBookingByProfileId(@RequestParam Integer profileId) { List<Booking>
	 * booking = bookingService.getBookingByProfileId(profileId); // TODO SYSO
	 * System.out.println("in resource " + booking);
	 * 
	 * return new ResponseEntity<>(booking, HttpStatus.OK); }
	 */
